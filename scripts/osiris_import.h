...
typedef int (*Obj_Create_fp)(ubyte type, ushort id, int roomnum, vector *pos, const matrix *orient, int parent_handle,
...
// but as soon as both are satisfied, the memory 	becomes deleted and any pointer returned by OMMS_Attach()
// becomes invalid.
//
