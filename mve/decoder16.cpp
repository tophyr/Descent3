  ...
  for (j = 0; j < yb; j++) {
    for (i = 0; i < xb / 2; i++) {
      ...
      /*
        ...
        & 0xf); else if ((unsigned short *)pFrame >= backBuf1 + g_width*g_height) fprintf(stderr, "danger!  pointing out
      ...
      */
      ...
      /*
        ...
        >> 4); else if ((unsigned short *)pFrame >= backBuf1 + g_width*g_height) fprintf(stderr, "danger!  pointing out
        of bounds above after dispatch decoder: %d, %d (2) [%x]\n", i, j, (*pMap) >> 4);
      */
