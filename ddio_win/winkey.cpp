...
bool ddio_InternalKeyInit(ddio_init_info *init_info) { return ddio_Win_KeyInit(); }
...
void ddio_InternalKeySuspend() { WKD.suspended = true; }

void ddio_InternalKeyResume() { WKD.suspended = false; }
