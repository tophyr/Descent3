...
void NewPltUpdate(newuiListBox *list, char **flist, int filecount, int selected, char *filename = nullptr,
                  bool presets = false);
...
// list =	buffer of memory that will be filled in with the filenames (each seperated by a \0) 	size	=
// size of memory allocated for list parm 	filecount = filled in with the number of files it found
