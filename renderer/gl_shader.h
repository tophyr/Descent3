...
public:
  ...
  void AttachSourcePreprocess(const char *vertexsource, const char *fragsource, bool textured, bool lightmapped,
                              bool speculared);
  ...
  GLuint Handle() const { return m_name; }
};
